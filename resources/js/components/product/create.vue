      ...
      enctype="multipart/form-data">
        ...
        <div class="form-group">
          <div class="form-row">
            ...
            <div class="col-md-6">
          <input type="text" class="form-control" id="exampleInputFirstName" placeholder="Enter Your Product Buying Price" v-model="form.buying_price">
  ...
  <select class="form-control" id="exampleFormControlSelect1"
   v-model="form.supplier_id">
          ...
          <small class="text-danger" v-if="errors.buying_date"> {{ errors.buying_date[0] }} </small>
          	...
          	<div class="col-md-6">
          <input type="number" class="form-control" id="exampleInputFirstName" placeholder="Enter product Quantity" v-model="form.product_quantity">
        ...
        <div class="form-group">
          <button type="submit" class="btn btn-primary btn-block">Product Insert</button>
        </div>
        <hr>
